...
import EchartsViews from './components/EchartsViews';
import b1 from '@/base/style/imgs/b1.jpg';

class Home extends React.Component {
    goToTable = () => {
        this.props.history.push('/main/demo/table/basicTable?id=1&name=zhangsan');
    }
    goToTable2 = () => {
        const _id = 3;
        this.props.history.push(`/main/demo/form/basicForm/${_id}`);
    }
    render() {
        return (
            <div className="gutter-example button-demo">
                ...
                <Row gutter={10}>
                    ...
                    <Col className="gutter-row" md={6}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                <div className="clear y-center" onClick={this.goToTable2}>
                                    <div className="pull-left mr-m">
